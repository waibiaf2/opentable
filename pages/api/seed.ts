...
export default async function handler(
  ...
  //   await prismadddddd.table.deleteMany();
  // await prismadddddd.review.deleteMany();
  await prisma.item.deleteMany();
  await prisma.restaurant.deleteMany();
  await prisma.location.deleteMany();
  await prisma.cuisine.deleteMany();
  // await prismadddddd.user.deleteMany();
  ...
  //   const userLaith = await prismadddddd.user.create({
  //     data: {
  //       first_name: "Laith",
  //       last_name: "Harb",
  ...
  //   const userJosh = await prismadddddd.user.create({
  //     data: {
  //       first_name: "Josh",
  //       last_name: "Allen",
  ...
  //   const userLebron = await prismadddddd.user.create({
  //     data: {
  //       first_name: "LeBron",
  //       last_name: "James",
  ...
  //   const userCassidy = await prismadddddd.user.create({
  //     data: {
  //       first_name: "Cassidy",
  //       last_name: "Marksom",
  ...
  //   await prismadddddd.review.createMany({
  //     data: [
  //       {
  //         first_name: "Laith",
  //         last_name: "Harb",
  ...
  //   await prismadddddd.table.createMany({
  //     data: [
  //       {
  //         restaurant_id: vivaanId,
  //         seats: 4,
