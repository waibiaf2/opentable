...
const ReviewCard = ({review}:{review: Review}) => {
	const getInitials = () => {
		const firstLetter = review.first_name.substring(0, 1).toUpperCase();
		const secondLetter = review.last_name.substring(0, 1).toUpperCase();
		...
		<div className="border-b pb-7 mb-7">
			<div className="flex">
				<div className="w-1/6 flex flex-col items-center">
					...
					>
						<h2 className="text-white text-2xl">{getInitials()}</h2>
					</div>
